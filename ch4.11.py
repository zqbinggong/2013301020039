#programming to show the trajectory of two-body system
#writen by zhangqiang,last modefied on 16/05/17
import math
from visual import *
import easygui as g

title='binary star system'
k=int(g.enterbox('Please choose the the value for M/m', title))
f=int(g.buttonbox('Please choose the initial speed' , title, choices=('1','3','5')))
m = 100
M = m * k
d = 100.
...
earth.velocity = vector(0,k*math.sqrt(m/(k+1)/d)/f,0)
